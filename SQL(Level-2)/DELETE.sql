...
-- 	Example:-
	DROP TABLE IF EXISTS employee;
		...
		--let we want to delete data of employees whose salary is above 80000
		DELETE FROM employee WHERE empSal>80000;
        --lets print the table it will not contain the data of employees aged above 30 and also of employees salary above 80k
